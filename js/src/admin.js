...
// module layout. The settings registry on this major is app.extensionData.
...
// Resolve a core component from 1.x's eager compat map.
...
window.app.initializers.add(EXT_ID, () => {
  ...
  try {
    if (app.extensionData && typeof app.extensionData.for === 'function') {
      registry = app.extensionData.for(EXT_ID);
    }
  } catch (e) {}
